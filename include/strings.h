...
extern const u8 gText_PokeSum_PageName_Contest[];
...
extern const u8 gText_PokeSum_Controls_PageRibbons[];
...
extern const u8 gText_English[];
extern const u8 gText_Spanish[];
extern const u8 gText_French[];
extern const u8 gText_Italian[];
extern const u8 gText_German[];
extern const u8 gText_Portuguese[];
