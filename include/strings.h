...
extern const u8 gText_PokeCoupons[];
extern const u8 gText_Brightpowder_PokeCoupons[];
extern const u8 gText_ChoiceBand_PokeCoupons[];
extern const u8 gText_FocusBand_PokeCoupons[];
extern const u8 gText_KingsRock_PokeCoupons[];
extern const u8 gText_Leftovers_PokeCoupons[];
extern const u8 gText_MentalHerb_PokeCoupons[];
extern const u8 gText_QuickClaw_PokeCoupons[];
extern const u8 gText_ScopeLens_PokeCoupons[];
extern const u8 gText_ShellBell_PokeCoupons[];
extern const u8 gText_WhiteHerb_PokeCoupons[];
extern const u8 gText_LuckyEgg_PokeCoupons[];
extern const u8 gText_ApicotBerry_PokeCoupons[];
extern const u8 gText_GanlonBerry_PokeCoupons[];
extern const u8 gText_PetayaBerry_PokeCoupons[];
extern const u8 gText_SalacBerry_PokeCoupons[];
extern const u8 gText_LiechiBerry_PokeCoupons[];
extern const u8 gText_LansatBerry_PokeCoupons[];
extern const u8 gText_StarfBerry_PokeCoupons[];
extern const u8 gText_MoonStone_PokeCoupons[];
extern const u8 gText_SunStone_PokeCoupons[];
extern const u8 gText_Exchange[];
extern const u8 gText_Brightpowder_Description[];
extern const u8 gText_ChoiceBand_Description[];
extern const u8 gText_FocusBand_Description[];
extern const u8 gText_KingsRock_Description[];
extern const u8 gText_Leftovers_Description[];
extern const u8 gText_MentalHerb_Description[];
extern const u8 gText_QuickClaw_Description[];
extern const u8 gText_ScopeLens_Description[];
extern const u8 gText_ShellBell_Description[];
extern const u8 gText_WhiteHerb_Description[];
extern const u8 gText_LuckyEgg_Description[];
extern const u8 gText_ApicotBerry_Description[];
extern const u8 gText_GanlonBerry_Description[];
extern const u8 gText_PetayaBerry_Description[];
extern const u8 gText_SalacBerry_Description[];
extern const u8 gText_LiechiBerry_Description[];
extern const u8 gText_LansatBerry_Description[];
extern const u8 gText_StarfBerry_Description[];
extern const u8 gText_EvolutionStone_Description[];
extern const u8 gText_Cancel_Description[];
