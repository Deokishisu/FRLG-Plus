...
#define FLAG_SYS_TOWER_SILVER                                       (SYS_FLAGS + 0xC3)
#define FLAG_SYS_TOWER_GOLD                                         (SYS_FLAGS + 0xC4)
#define FLAG_SYS_DOME_SILVER                                        (SYS_FLAGS + 0xC5)
#define FLAG_SYS_DOME_GOLD                                          (SYS_FLAGS + 0xC6)
#define FLAG_SYS_PALACE_SILVER                                      (SYS_FLAGS + 0xC7)
#define FLAG_SYS_PALACE_GOLD                                        (SYS_FLAGS + 0xC8)
#define FLAG_SYS_ARENA_SILVER                                       (SYS_FLAGS + 0xC9)
#define FLAG_SYS_ARENA_GOLD                                         (SYS_FLAGS + 0xCA)
#define FLAG_SYS_FACTORY_SILVER                                     (SYS_FLAGS + 0xCB)
#define FLAG_SYS_FACTORY_GOLD                                       (SYS_FLAGS + 0xCC)
#define FLAG_SYS_PIKE_SILVER                                        (SYS_FLAGS + 0xCD)
#define FLAG_SYS_PIKE_GOLD                                          (SYS_FLAGS + 0xCE)
#define FLAG_SYS_PYRAMID_SILVER                                     (SYS_FLAGS + 0xCF)
#define FLAG_SYS_PYRAMID_GOLD                                       (SYS_FLAGS + 0xD0)
#define FLAG_SYS_FRONTIER_PASS                                      (SYS_FLAGS + 0xD1)
