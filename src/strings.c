...
const u8 gExpandedPlaceholder_Pokedex[] = _("POKéDEX");
const u8 gExpandedPlaceholder_Poke[] = _("POKé");
const u8 gExpandedPlaceholder_NoFreeHeals[] = _("NO FREE HEALS");
const u8 gExpandedPlaceholder_NuzlockeMode[] = _("NUZLOCKE MODE");
...
const u8 gText_PokeSum_PageName_Contest[] = _("CONTEST INFO");
...
const u8 gText_PokeSum_Controls_PageDetail[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}DETAIL");
const u8 gText_PokeSum_Controls_PageRibbons[] = _("{DPAD_LEFT}PAGE {A_BUTTON}RIBBONS");
...
const u8 gText_English[] = _("ENGLISH");
const u8 gText_Spanish[] = _("ESPAÑOL");
const u8 gText_French[] = _("FRANÇAIS");
const u8 gText_Italian[] = _("ITALIANO");
const u8 gText_German[] = _("DEUTSCH");
const u8 gText_Portuguese[] = _("PORTUGUÊS");
