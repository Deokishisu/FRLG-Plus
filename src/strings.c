...
const u8 gText_Espeon[] = _("ESPEON");
const u8 gText_Umbreon[] = _("UMBREON");
const u8 gText_NextPage[] = _("NEXT PAGE");
const u8 gText_PrevPage[] = _("PREV. PAGE");
...
const u8 gText_PickBackA[] = _("{A_BUTTON}GO {L_BUTTON}HELP{CLEAR 13}{DPAD_UPDOWN}PICK{CLEAR 89}{B_BUTTON}BACK");
const u8 gText_PickBack[] = _("{L_BUTTON}HELP{CLEAR 13}{DPAD_UPDOWN}PICK{CLEAR 81}{A_BUTTON}{B_BUTTON}BACK");
const u8 gText_SavingDontTurnOffThePower2[] = _("SAVING…\nDON'T TURN OFF THE POWER.");
const u8 gText_TextSpeedInstant[] = _("INSTANT");
const u8 gText_ThrowAnim[] = _("THROW BALL ANIM");
...
const u8 gText_KeySystem_On[] = _("ON");
const u8 gText_KeySystem_Off[] = _("OFF");
...
const u8 gText_MaxLvlEvolve[] = _("MAX LVL EVOLVE");
const u8 gText_OwPoisonDamage[] = _("OW POISON DMG");
const u8 gText_OwPoisonDamageStandard[] = _("STANDARD");
...
const u8 gText_PkmnWasGivenItem2[] = _("{STR_VAR_1} was given the\n{STR_VAR_2} to hold.\p");
