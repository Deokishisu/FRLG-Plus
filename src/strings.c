...
const u8 gText_1000Coins_20000[] = _("{FONT_0}1000 COINS{CLEAR_TO 0x40}¥20,000");
...
const u8 gText_BlueFlute_Ash[] = _("{FONT_0}BLUE FLUTE{CLEAR_TO 0x40} 250");
const u8 gText_YellowFlute_Ash[] = _("{FONT_0}YELLOW FLUTE{CLEAR_TO 0x40} 500");
const u8 gText_RedFlute_Ash[] = _("{FONT_0}RED FLUTE{CLEAR_TO 0x40} 500");
const u8 gText_WhiteFlute_Ash[] = _("{FONT_0}WHITE FLUTE{CLEAR_TO 0x40}1000");
const u8 gText_BlackFlute_Ash[] = _("{FONT_0}BLACK FLUTE{CLEAR_TO 0x40}1000");
const u8 gText_AshQuantity[] = _("ASH QUANTITY: {STR_VAR_1}{PAUSE_UNTIL_PRESS}");
const u8 gText_SmallExit[] = _("{FONT_0}EXIT");
