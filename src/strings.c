...
const u8 gUnknown_8416644[] = _("POWDER QUANTITY: {STR_VAR_1}{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CanIHelpWithAnythingElse[] = _("{COLOR BLUE}Is there anything else I can do?");
...
const u8 gText_1000Coins_20000[] = _("{SMALL}1000 COINS{CLEAR_TO 0x40}¥20,000");
...
const u8 gText_CanIHelpWithAnythingElseF[] = _("{COLOR RED}Is there anything else I can do?");
...
const u8 gText_PokeCoupons[] = _("{CLEAR_TO 0x04}{SMALL}POKé COUPONS$");
const u8 gText_Brightpowder_PokeCoupons[] = _("BRIGHTPOWDER{CLEAR_TO 0x55}{SMALL} 8000pt");
const u8 gText_ChoiceBand_PokeCoupons[] = _("CHOICE BAND{CLEAR_TO 0x55}{SMALL} 8000pt");
const u8 gText_FocusBand_PokeCoupons[] = _("FOCUS BAND{CLEAR_TO 0x55}{SMALL} 8000pt");
const u8 gText_KingsRock_PokeCoupons[] = _("KING'S ROCK{CLEAR_TO 0x55}{SMALL} 8000pt");
const u8 gText_Leftovers_PokeCoupons[] = _("LEFTOVERS{CLEAR_TO 0x55}{SMALL} 8000pt");
const u8 gText_MentalHerb_PokeCoupons[] = _("MENTAL HERB{CLEAR_TO 0x55}{SMALL} 6000pt");
const u8 gText_QuickClaw_PokeCoupons[] = _("QUICK CLAW{CLEAR_TO 0x55}{SMALL} 8000pt");
const u8 gText_ScopeLens_PokeCoupons[] = _("SCOPE LENS{CLEAR_TO 0x55}{SMALL} 8000pt");
const u8 gText_ShellBell_PokeCoupons[] = _("SHELL BELL{CLEAR_TO 0x55}{SMALL} 8000pt");
const u8 gText_WhiteHerb_PokeCoupons[] = _("WHITE HERB{CLEAR_TO 0x55}{SMALL} 6000pt");
const u8 gText_LuckyEgg_PokeCoupons[] = _("LUCKY EGG{CLEAR_TO 0x54}{SMALL} 10000pt");
const u8 gText_ApicotBerry_PokeCoupons[] = _("APICOT BERRY{CLEAR_TO 0x55}{SMALL} 2500pt");
const u8 gText_GanlonBerry_PokeCoupons[] = _("GANLON BERRY{CLEAR_TO 0x55}{SMALL} 2500pt");
const u8 gText_PetayaBerry_PokeCoupons[] = _("PETAYA BERRY{CLEAR_TO 0x55}{SMALL} 2500pt");
const u8 gText_SalacBerry_PokeCoupons[] = _("SALAC BERRY{CLEAR_TO 0x55}{SMALL} 2500pt");
const u8 gText_LiechiBerry_PokeCoupons[] = _("LIECHI BERRY{CLEAR_TO 0x55}{SMALL} 2500pt");
const u8 gText_LansatBerry_PokeCoupons[] = _("LANSAT BERRY{CLEAR_TO 0x55}{SMALL} 2500pt");
const u8 gText_StarfBerry_PokeCoupons[] = _("STARF BERRY{CLEAR_TO 0x55}{SMALL} 2500pt");
const u8 gText_MoonStone_PokeCoupons[] = _("MOON STONE{CLEAR_TO 0x55}{SMALL} 1000pt");
const u8 gText_SunStone_PokeCoupons[] = _("SUN STONE{CLEAR_TO 0x55}{SMALL} 1000pt");
const u8 gText_Exchange[] = _("EXCHANGE");

const u8 gText_Brightpowder_Description[] = _("A hold item that casts a glare\nto reduce accuracy.$");
const u8 gText_ChoiceBand_Description[] = _("Raises a move's power, but\npermits only that move.$");
const u8 gText_FocusBand_Description[] = _("A hold item that occasionally\nprevents fainting.$");
const u8 gText_KingsRock_Description[] = _("A hold item that may cause\nflinching when the foe is hit.$");
const u8 gText_Leftovers_Description[] = _("A hold item that gradually restores\nHP in battle.$");
const u8 gText_MentalHerb_Description[] = _("A hold item that snaps POKéMON\nout of infatuation.$");
const u8 gText_QuickClaw_Description[] = _("A hold item that occasionally\nallows the first strike.$");
const u8 gText_ScopeLens_Description[] = _("A hold item that raises the\ncritical-hit rate.$");
const u8 gText_ShellBell_Description[] = _("A hold item that restores HP\nupon striking the foe.$");
const u8 gText_WhiteHerb_Description[] = _("A hold item that restores any\nlowered stat.$");
const u8 gText_LuckyEgg_Description[] = _("A hold item that boosts EXP.\npoints earned in battle.$");
const u8 gText_ApicotBerry_Description[] = _("A hold item that raises SP. DEF\nin a pinch.$");
const u8 gText_GanlonBerry_Description[] = _("A hold item that raises DEFENSE\nin a pinch.$");
const u8 gText_PetayaBerry_Description[] = _("A hold item that raises SP. ATK\nin a pinch.$");
const u8 gText_SalacBerry_Description[] = _("A hold item that raises SPEED\nin a pinch.$");
const u8 gText_LiechiBerry_Description[] = _("A hold item that raises ATTACK\nin a pinch.$");
const u8 gText_LansatBerry_Description[] = _("A hold item that ups the critical-\nhit rate in a pinch.$");
const u8 gText_StarfBerry_Description[] = _("A hold item that sharply boosts a\nstat in a pinch.$");
const u8 gText_EvolutionStone_Description[] = _("Makes certain species of\nPOKéMON evolve.$");
const u8 gText_Cancel_Description[] = _("Return to the field.$");
