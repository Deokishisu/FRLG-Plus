...
const u16 gConditionGraphData_Pal[] = INCBIN_U16("graphics/condition/graph_data.gbapal");
const u16 gConditionText_Pal[] = INCBIN_U16("graphics/condition/text.gbapal");
...
static void LoadUsePokeblockMenu(void)
{
    ...
    case 3:
        ...
        LoadUserWindowGfx(0, 0x97, BG_PLTT_ID(14));
        sInfo->mainState++;
        break;
    case 4:
        sInfo->mainState++;
...
static void AskUsePokeblock(void)
{
    ...
    CreateYesNoMenu(&sUsePokeblockYesNoWinTemplate, FONT_NORMAL, 0, 1, 151, 14, 0);
}
