...
static void InitContestMonPixels(u16 species, bool8 backPic)
{
    ...
    if (!backPic)
    {
        ...
        _InitContestMonPixels(gMonSpritesGfxPtr->sprites[B_POSITION_OPPONENT_LEFT], gContestPaintingMonPalette, (void *)gContestMonPixels);
    }
    else
    {
        HandleLoadSpecialPokePic_DontHandleDeoxys(
            ...
            species,
            gContestPaintingWinner->personality);
        _InitContestMonPixels(gMonSpritesGfxPtr->sprites[B_POSITION_PLAYER_LEFT], gContestPaintingMonPalette, (void *)gContestMonPixels);
    }
}
