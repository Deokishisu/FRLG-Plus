...
{
    [PKBL_USE_ON_FIELD]  = {gOtherText_Use, {PokeblockAction_UseOnField}},
    [PKBL_TOSS]          = {gOtherText_Toss, {PokeblockAction_Toss}},
    [PKBL_CANCEL]        = {gText_OptionMenuCancel, {PokeblockAction_Cancel}},
    [PKBL_USE_IN_BATTLE] = {gOtherText_Use, {PokeblockAction_UseInBattle}},
    [PKBL_USE_ON_FEEDER] = {gOtherText_Use, {PokeblockAction_UseOnPokeblockFeeder}},
    [PKBL_GIVE_TO_LADY]  = {gOtherText_Give, {PokeblockAction_GiveToContestLady}},
};
...
static void HandleInitWindows(void)
{
    ...
    LoadStdWindowGfx(0, 0xA, BG_PLTT_ID(13));
...
static void UpdatePokeblockList(void)
{
    ...
    for (i = 0; i < sPokeblockMenu->itemsNo - 1; i++)
    {
        ...
        sPokeblockMenu->items[i].label = sPokeblockMenu->menuItemsStrings[i];
        sPokeblockMenu->items[i].index = i;
    }
...
static void PokeblockAction_Toss(u8 taskId)
{
    ...
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, FONT_NORMAL, GetTextSpeedSetting(), gStringVar4, CreateTossPokeblockYesNoMenu);
}
...
static void TossedPokeblockMessage(u8 taskId)
{
    ...
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, FONT_NORMAL, GetTextSpeedSetting(), gStringVar4, TossPokeblock);
}
