...
#ifdef TM_CASE_MON_SPRITES
const u32 gTMCaseMenu_Tilemap[] = INCBIN_U32("graphics/new/tm_case/menu.bin.lz");
const u32 gTMCase_Tilemap[] = INCBIN_U32("graphics/new/tm_case/tm_case.bin.lz");
#else // TM_CASE_MON_SPRITES
