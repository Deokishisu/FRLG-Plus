...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_CABLE_CAR /2]                = 0x22, // OBJ_EVEN_GFX_SUDOWOODO
    [OBJ_EVENT_GFX_ABRA /2]                     = 0x12, // OBJ_EVENT_GFX_SWIMMER_F_WATER_2
    [OBJ_EVENT_GFX_MASTER_BEAUTY / 2]           = 0x01, // OBJ_EVENT_GFX_MASTER_BIRD_KEEPER
    ...
    [OBJ_EVENT_GFX_DELCATTY / 2]                = 0x02, // OBJ_EVENT_GFX_XD_CURMUDGEON 
    [OBJ_EVENT_GFX_XD_NURSE / 2]                = 0x11, // OBJ_EVENT_GFX_XD_RECEPTIONIST
};
