...
//#include "constants/field_specials.h" // doesn't exist
...
{
    .data = gFile_graphics_misc_confetti_sheet,
    .size = 0x220,
    .tag = TAG_CONFETTI
};
...
{
    .data = gFile_graphics_misc_confetti_palette,
    .tag = TAG_CONFETTI
};
...
static void Task_ShowContestEntryMonPic(u8 taskId)
{
    ...
    case 1:
        ...
        SetStdWindowBorderStyle(task->data[5], TRUE);
        task->data[0]++;
        break;
    case 2:
        break;
