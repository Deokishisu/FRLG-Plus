...
static void Task_SetClock_AskConfirm(u8 taskId)
{
    ...
    AddTextPrinterParameterized(WIN_MSG, 1, gText_IsThisTheCorrectTime, 0, 1, 0, NULL);
    PutWindowTilemap(WIN_MSG);
    ScheduleBgCopyTilemapToVram(0);
    LoadUserWindowGfx(0, 0x140, 0xE0);
    CreateYesNoMenu(&sWindowTemplate_ConfirmYesNo, 3, 0, 2, 0x140, 0xE, 0);
