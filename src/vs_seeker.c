...
static const VsSeekerData sVsSeekerData[] = {
   ...
   { {TRAINER_GENTLEMAN_CLIFFORD, TRAINER_GENTLEMAN_CLIFFORD},
      MAP_GROUP(SEVEN_ISLAND_TANOBY_RUINS), MAP_NUM(SEVEN_ISLAND_TANOBY_RUINS) },
   { {TRAINER_PKMN_RANGER_HELENA, 0xFFFF, 0xFFFF, 0xFFFF, TRAINER_PKMN_RANGER_HELENA_2},
      MAP_GROUP(TWO_ISLAND_CAPE_BRINK), MAP_NUM(TWO_ISLAND_CAPE_BRINK) },
   { {TRAINER_COOLTRAINER_ATTICUS, 0xFFFF, 0xFFFF, 0xFFFF, TRAINER_COOLTRAINER_ATTICUS_2},
      MAP_GROUP(TWO_ISLAND_CAPE_BRINK), MAP_NUM(TWO_ISLAND_CAPE_BRINK) },
   { {TRAINER_FISHERMAN_DEFOREST, 0xFFFF, 0xFFFF, 0xFFFF, TRAINER_FISHERMAN_DEFOREST_2},
      MAP_GROUP(TWO_ISLAND_CAPE_BRINK), MAP_NUM(TWO_ISLAND_CAPE_BRINK) },
   { {TRAINER_BIRD_KEEPER_SPEDO, 0xFFFF, 0xFFFF, 0xFFFF, TRAINER_BIRD_KEEPER_SPEDO_2},
      MAP_GROUP(TWO_ISLAND_CAPE_BRINK), MAP_NUM(TWO_ISLAND_CAPE_BRINK) },
   { {TRAINER_COOLTRAINER_CASPARA, 0xFFFF, 0xFFFF, 0xFFFF, TRAINER_COOLTRAINER_CASPARA_2},
      MAP_GROUP(TWO_ISLAND_CAPE_BRINK), MAP_NUM(TWO_ISLAND_CAPE_BRINK) },
   { {TRAINER_SWIMMER_FEMALE_SEDEF, 0xFFFF, 0xFFFF, 0xFFFF, TRAINER_SWIMMER_FEMALE_SEDEF_2},
      MAP_GROUP(TWO_ISLAND_CAPE_BRINK), MAP_NUM(TWO_ISLAND_CAPE_BRINK) },
};
