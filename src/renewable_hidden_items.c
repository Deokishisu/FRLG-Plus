...
static const struct RenewableHiddenItemData sRenewableHiddenItems[] = {
    ...
    },
    {
        ...
        .rare = {
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_KELPSY_BERRY, //Changed from Bluk
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_HONDEW_BERRY, //Changed from Wepear
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_SITRUS_BERRY, //Changed from Oran
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAWST_BERRY,
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_TAMATO_BERRY, //Changed from Aspear
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PERSIM_BERRY,
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_GREPA_BERRY, //Changed from Pinap
        ...
        .uncommon = {
            ...
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PERSIM_BERRY,
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_GREPA_BERRY, //Changed from Pinap
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_TAMATO_BERRY //New
        },
        .common = {
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_POMEG_BERRY, //Changed from Razz
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_QUALOT_BERRY, //Changed from Nanab
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHESTO_BERRY,
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PECHA_BERRY,
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_GREPA_BERRY, //Changed from Rawst
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_TAMATO_BERRY, //New
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_KELPSY_BERRY,
            HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_HONDEW_BERRY
        }
    },
    {
