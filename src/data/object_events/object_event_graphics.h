...
const u16 gObjectEventPic_Delcatty[] = INCBIN_U16("graphics/object_events/pics/pokemon/delcatty.4bpp");
const u16 gObjectEventPic_Curmudgeon[] = INCBIN_U16("graphics/object_events/pics/people/xd_curmudgeon.4bpp");
const u16 gObjectEventPic_XDNurse[] = INCBIN_U16("graphics/object_events/pics/people/xd_nurse.4bpp");
const u16 gObjectEventPic_XDReceptionist[] = INCBIN_U16("graphics/object_events/pics/people/xd_receptionist.4bpp");
