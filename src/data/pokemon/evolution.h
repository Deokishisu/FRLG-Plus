const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH, 0},
                            ...
                            {EVO_LEVEL, 35, SPECIES_POLITOED, 0}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO, 0},
                            ...
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_SLOWKING, 0}},
    ...
    [SPECIES_ONIX]       = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX, 0},
                            ...
                            {EVO_LEVEL, 32, SPECIES_STEELIX, 0}},
    ...
    [SPECIES_SEADRA]     = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA, 0},
                            ...
                            {EVO_LEVEL, 44, SPECIES_KINGDRA, 0}},
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON, 0},
                            ...
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON, 0},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON, 0}},
    [SPECIES_PORYGON]    = {{EVO_TRADE_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2, 0},
                            ...
                            {EVO_LEVEL, 31, SPECIES_PORYGON2, 0}},
    ...
    [SPECIES_SMOOCHUM]   = {{EVO_LEVEL, 24, SPECIES_JYNX, 0}},
    [SPECIES_ELEKID]     = {{EVO_LEVEL, 24, SPECIES_ELECTABUZZ, 0}},
    [SPECIES_MAGBY]      = {{EVO_LEVEL, 24, SPECIES_MAGMAR, 0}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_BEAUTY, 170, SPECIES_MILOTIC, 0},
                            {EVO_LEVEL, 20, SPECIES_MILOTIC, 0}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_STONE_HELD, ITEM_LINK_BRACELET, SPECIES_HUNTAIL, ITEM_DEEP_SEA_TOOTH},
                            {EVO_STONE_HELD, ITEM_LINK_BRACELET, SPECIES_GOREBYSS, ITEM_DEEP_SEA_SCALE},
                            {EVO_LEVEL, 18, SPECIES_GOREBYSS, 0},
                            {EVO_LEVEL, 18, SPECIES_HUNTAIL, 0}},
