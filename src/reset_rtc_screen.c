...
static const u16 sBg_Pal[] = INCBIN_U16("graphics/reset_rtc_screen/bg_palette.gbapal");
...
static void ShowChooseTimeWindow(u8 windowId, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterized(windowId, 1, gOtherText_Confirm, 126, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
...
void CB2_InitResetRtcScreen(void)
{
    ...
    LoadPalette(sBg_Pal, BG_PLTT_ID(0), 8 * PLTT_SIZE_4BPP);
...
static void ShowMessage(const u8 *str)
{
    ...
    AddTextPrinterParameterized(WIN_MSG, 1, str, 0, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
